...
class BouncesHigherOff extends Comparator {
    ...
    checkConditions() {
        ...
        return (currentCandle.c > indicator2Value && currentCandle.l <= indicator2Value && currentCandle.c > currentCandle.o);
    }
}

module.exports = BouncesHigherOff